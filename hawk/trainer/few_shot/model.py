...
from hawk.trainer.few_shot.models.SnaTCHerF import SnaTCHerF
...
class FewShotModel(ModelBase):
    ...
    def load_model(self, model_path: Path):
        ...
        args=Namespace(backbone_class='Res12', closed_way=5, gpu='0', multi_gpu=False, shot=5)
    ...
    def get_predictions(self, inputs: torch.Tensor) -> List[float]:
        ...
        qlogits = -(query.reshape(-1, 1, self.emb_dim) - self.support_proto).pow(2).sum(2) / 64.0
