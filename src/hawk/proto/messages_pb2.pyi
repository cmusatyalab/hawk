...
class _HawkObject(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    content: builtin___bytes = ...
...
type____HawkObject = _HawkObject
...
class SendTile(google___protobuf___message___Message):
    ...
    @property
    def oracle_data(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type____HawkObject]: ...

    @property
    def inferenced(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type____BoundingBox]: ...

    @property
    def groundtruth(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type____BoundingBox]: ...
    ...
    def __init__(self,
        *,
        ...
        scoutIndex : typing___Optional[builtin___int] = None,
        version : typing___Optional[builtin___int] = None,
        oracle_data : typing___Optional[typing___Iterable[type____HawkObject]] = None,
        inferenced : typing___Optional[typing___Iterable[type____BoundingBox]] = None,
        groundtruth : typing___Optional[typing___Iterable[type____BoundingBox]] = None,
        feature_vector : typing___Optional[builtin___bytes] = None,
        novel_sample : typing___Optional[builtin___bool] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"_objectId",b"_objectId",u"feature_vector",b"feature_vector",u"groundtruth",b"groundtruth",u"inferenced",b"inferenced",u"novel_sample",b"novel_sample",u"oracle_data",b"oracle_data",u"scoutIndex",b"scoutIndex",u"version",b"version"]) -> None: ...
...
class SendLabel(google___protobuf___message___Message):
    ...
    @property
    def boundingBoxes(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type____BoundingBox]: ...

    def __init__(self,
        *,
        _objectId : typing___Optional[typing___Text] = None,
        scoutIndex : typing___Optional[builtin___int] = None,
        boundingBoxes : typing___Optional[typing___Iterable[type____BoundingBox]] = None,
        ) -> None: ...
...
class LabeledTile(google___protobuf___message___Message):
    ...
    @property
    def obj(self) -> type____HawkObject: ...

    @property
    def feature_vector(self) -> type____HawkObject: ...
    ...
    def __init__(self,
        *,
        _objectId : typing___Optional[typing___Text] = None,
        obj : typing___Optional[type____HawkObject] = None,
        feature_vector : typing___Optional[type____HawkObject] = None,
        boundingBoxes : typing___Optional[typing___Iterable[type____BoundingBox]] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"feature_vector",b"feature_vector",u"obj",b"obj"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"_objectId",b"_objectId",u"boundingBoxes",b"boundingBoxes",u"feature_vector",b"feature_vector",u"obj",b"obj"]) -> None: ...
type___LabeledTile = LabeledTile

class _BoundingBox(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    x: builtin___float = ...
    y: builtin___float = ...
    w: builtin___float = ...
...
type____BoundingBox = _BoundingBox
