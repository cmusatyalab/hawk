...
class ChangeDeploymentStatus(google___protobuf___message___Message):
    ...
    NumActiveScouts: builtin___int = ...

    def __init__(self,
        *,
        ActiveStatus : typing___Optional[builtin___bool] = None,
        NumActiveScouts : typing___Optional[builtin___int] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"ActiveStatus",b"ActiveStatus",u"NumActiveScouts",b"NumActiveScouts"]) -> None: ...
