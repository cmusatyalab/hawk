...
class SelectiveConfig(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"threshold",b"threshold",u"token",b"token",u"topk",b"topk",u"value",b"value"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"threshold",b"threshold",u"token",b"token",u"topk",b"topk",u"value",b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"value",b"value"]) -> typing_extensions___Literal["topk","threshold","token"]: ...
...
class TopKConfig(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"batchSize",b"batchSize",u"k",b"k"]) -> None: ...
...
class TokenConfig(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"batch_size",b"batch_size",u"initial_samples",b"initial_samples"]) -> None: ...
...
class LabeledTile(google___protobuf___message___Message):
    ...
    @property
    def object(self) -> type___HawkObject: ...
    ...
    def __init__(self,
        *,
        object : typing___Optional[type___HawkObject] = None,
        label : typing___Optional[type___LabelWrapper] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"label",b"label",u"object",b"object"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"label",b"label",u"object",b"object"]) -> None: ...
