...
class TrainConfig(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"dnn_classifier",b"dnn_classifier",u"dnn_classifier_radar",b"dnn_classifier_radar",u"fsl",b"fsl",u"value",b"value",u"yolo",b"yolo"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"dnn_classifier",b"dnn_classifier",u"dnn_classifier_radar",b"dnn_classifier_radar",u"fsl",b"fsl",u"value",b"value",u"yolo",b"yolo"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"value",b"value"]) -> typing_extensions___Literal["dnn_classifier","yolo","fsl","dnn_classifier_radar"]: ...
