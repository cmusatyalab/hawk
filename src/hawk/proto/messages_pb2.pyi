...
class TrainConfig(google___protobuf___message___Message):
    ...
    @property
    def activity_classifier(self) -> type___ModelConfig: ...
    ...
    def __init__(self,
        *,
        ...
        activity_classifier : typing___Optional[type___ModelConfig] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"activity_classifier",b"activity_classifier",u"dnn_classifier",b"dnn_classifier",u"dnn_classifier_radar",b"dnn_classifier_radar",u"fsl",b"fsl",u"value",b"value",u"yolo",b"yolo",u"yolo_radar",b"yolo_radar"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"activity_classifier",b"activity_classifier",u"dnn_classifier",b"dnn_classifier",u"dnn_classifier_radar",b"dnn_classifier_radar",u"fsl",b"fsl",u"value",b"value",u"yolo",b"yolo",u"yolo_radar",b"yolo_radar"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"value",b"value"]) -> typing_extensions___Literal["dnn_classifier","yolo","fsl","dnn_classifier_radar","yolo_radar","activity_classifier"]: ...
...
class Dataset(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        retriever : typing___Optional[typing___Text] = None,
        config : typing___Optional[typing___Mapping[typing___Text, typing___Text]] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"config",b"config",u"retriever",b"retriever"]) -> None: ...
...
class ChangeDeploymentStatus(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"ActiveStatus",b"ActiveStatus"]) -> None: ...
