...
class Dataset(google___protobuf___message___Message):
    ...
    @property
    def activity(self) -> type___FileDataset: ...
    ...
    def __init__(self,
        *,
        ...
        activity : typing___Optional[type___FileDataset] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"activity",b"activity",u"frame",b"frame",u"network",b"network",u"random",b"random",u"scope",b"scope",u"tile",b"tile",u"value",b"value",u"video",b"video"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"activity",b"activity",u"frame",b"frame",u"network",b"network",u"random",b"random",u"scope",b"scope",u"tile",b"tile",u"value",b"value",u"video",b"video"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"value",b"value"]) -> typing_extensions___Literal["frame","random","tile","scope","video","network","activity"]: ...
...
class FileDataset(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"N",b"N",u"dataPath",b"dataPath",u"fps",b"fps",u"numTiles",b"numTiles",u"resizeTile",b"resizeTile",u"tileSize",b"tileSize",u"timeout",b"timeout"]) -> None: ...
...
class HawkObject(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        _objectId : typing___Optional[typing___Text] = None,
        content : typing___Optional[builtin___bytes] = None,
        attributes : typing___Optional[typing___Mapping[typing___Text, builtin___bytes]] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"_objectId",b"_objectId",u"attributes",b"attributes",u"content",b"content"]) -> None: ...
...
class SendTile(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"_objectId",b"_objectId",u"attributes",b"attributes",u"boundingBoxes",b"boundingBoxes",u"feature_vector",b"feature_vector",u"novel_sample",b"novel_sample",u"scoutIndex",b"scoutIndex",u"version",b"version"]) -> None: ...
...
class SendLabel(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"_objectId",b"_objectId",u"boundingBoxes",b"boundingBoxes",u"scoutIndex",b"scoutIndex"]) -> None: ...
