...
class TrainConfig(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        trainer : typing___Optional[typing___Text] = None,
        config : typing___Optional[typing___Mapping[typing___Text, typing___Text]] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"config",b"config",u"trainer",b"trainer"]) -> None: ...
